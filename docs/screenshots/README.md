...
This directory contains screenshots of the ChatCompanion application for documentation purposes.

## Required Screenshots

Please add the following screenshot files:

- `main-interface.png` - Main chat input screen with example buttons
...
- Size: Keep under 1MB per image for GitHub inline display
- Resolution: 1920x1080 or similar (screenshots should be clear and readable)
- Naming: Use kebab-case as shown above
