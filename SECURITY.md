...
1. **GitHub Security Advisory**: Use the "Report a vulnerability" button on the [Security tab](https://github.com/andreaseirich/ChatCompanion/security) of this repository.
